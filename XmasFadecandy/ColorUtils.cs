...
namespace XmasFadecandy
{
    public class HSLColor
    {
        ...
        public HSLColor(int wheelPos){
            var pos = 255 - wheelPos;
            if(pos < 85){
                this.SetRGB(255 - pos*3,0,pos*3);
            }else if(pos < 170){
                pos -= 85;
                this.SetRGB(0,pos*3,255-pos*3);
            }else{
                pos -= 170;
                this.SetRGB(pos*3,255- pos*3,0);
            }
        }

        public static HSLColor White(){
            return new HSLColor(255,255,255);
        }

        public static HSLColor Red(){
            return new HSLColor(255,0,0);
        }

        public static HSLColor Green(){
            return new HSLColor(0,255,0);
        }

        public static HSLColor Blue(){
            return new HSLColor(0,0,255);
        }
